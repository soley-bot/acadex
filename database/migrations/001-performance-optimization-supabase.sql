-- =====================================================
-- PERFORMANCE OPTIMIZATION MIGRATION - PHASE 1 (SUPABASE VERSION)
...
-- This version removes BEGIN/COMMIT because Supabase doesn't allow
-- CREATE INDEX CONCURRENTLY inside transaction blocks.
...
-- Copy the original policy definitions from your schema file
*/
