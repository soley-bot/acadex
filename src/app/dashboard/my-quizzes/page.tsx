...
import type { QuizAttempt } from '@/types/dashboard'
            ...
            {quizAttempts.length > 0 ? (
              ...
              <Card variant="default">
                <CardContent className="!p-6 sm:!p-8 md:!p-10 lg:!p-12 text-center">
                  <Brain className="h-12 w-12 sm:h-14 sm:w-14 md:h-16 md:w-16 text-gray-300 mx-auto mb-3 sm:mb-4" />
                  <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2">No Quiz Attempts Yet</h3>
