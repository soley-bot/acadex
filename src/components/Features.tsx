  ...
  const features = [
    {
      ...
      description: "Test your knowledge with beautifully designed, interactive quizzes that adapt to your learning pace."
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: "Learn from industry experts with comprehensive courses designed to advance your career."
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: "Join a vibrant community of learners and share knowledge with peers worldwide."
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: "Your learning data is protected with enterprise-grade security and 99.9% uptime."
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: "AI-powered recommendations ensure you get the most relevant content for your goals."
    }
  ]
