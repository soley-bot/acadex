...
import { Brain, Loader2, Settings, Eye, EyeOff, HelpCircle } from 'lucide-react'
...
export function EnhancedAIQuizGenerator({ isOpen, onClose, onQuizGenerated }: EnhancedQuizGeneratorProps) {
  ...
  const previewPrompts = async () => {
    try {
      setLoading(true)
      const response = await fetch('/api/admin/preview-quiz-prompts', {
        method: 'POST',
  ...
  return (
    <>
      <BaseModal 
        isOpen={isOpen} 
        onClose={onClose}
        title="Enhanced AI Quiz Generator"
        size="lg"
      >
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                placeholder="e.g., Quadratic Equations, Cell Biology, World War II, React Hooks"
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent"
                disabled={loading}
                required
              />
          ...
          {/* Advanced Settings */}
          {showAdvanced && (
            <div className="space-y-4 border border-secondary/20 rounded-lg p-4 bg-secondary/5">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  Advanced types like matching and ordering work best with intermediate/advanced difficulty
                </p>
              </div>
              ...
              <button
                ...
                className="w-full px-4 py-2 border border-secondary text-secondary hover:bg-secondary/10 rounded-lg transition-colors flex items-center justify-center gap-2"
                disabled={loading}
              >
      ...
      {promptPreview && (
        <BaseModal
          ...
          title="Generated Prompts Preview"
          size="lg"
        >
          <div className="space-y-4">
            <div>
            ...
            <div>
              <h4 className="font-medium text-gray-900 mb-2">Main Prompt:</h4>
