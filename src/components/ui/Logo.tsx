...
const sizeMap = {
  ...
  md: { width: 32, height: 28 },
  lg: { width: 48, height: 42 },
  xl: { width: 64, height: 56 }
}
...
export const Logo: React.FC<LogoProps> = ({ 
  ...
  const dimensions = size ? sizeMap[size] : { width: width || 32, height: height || 28 }
  
  return (
    <svg
      id="acadex-logo"
      data-name="Acadex Logo"
